...
// a single full-screen Blend2D-painted backdrop (radial gradient
// over dark blue, the conventional cluster aesthetic) plus the
// standard libseat session + libinput keyboard + VT-switch
// boilerplate.
// Key bindings:
//   Esc / q / Ctrl-C — quit.
...
// settle on); edges fade darker so the dial layers
